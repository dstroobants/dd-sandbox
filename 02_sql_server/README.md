...
1. `Docker exec -it <SQL_SERVER_CONTAINER_ID> bash`
2. `sqlcmd -U datadog -P D4t4dog-2024 -N -C`

## Reasons why SQL Server on Linux is tricky and why this sandbox exists
...
The reality is that there are no microsoft odbc package for debian12, the Microsoft documentation is 
